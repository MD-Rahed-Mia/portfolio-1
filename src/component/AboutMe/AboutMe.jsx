        ...
        <div className="am-container">
          ...
          <div className="am-container-right">
            ...
            <p>
              ...
              overall value proposition. I am a junior front end developer. I
              like to learn new technologies. Though, I am junior in front end I
              have more than 2 year's of experience in this sector. I have
              knowledge of front end developer also in backend.
            </p>
          </div>
        </div>
      </div>
